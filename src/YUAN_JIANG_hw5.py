...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 28 19:47:35 2019
...
class dataset:
    ...
    def getlnglat(self,address):
        ...
        output = 'json'
        ak = 'dHxEEgwjUsrqManYTG4YBRCDLrGu4DGG'#'ujZuFx0KaGoUajkWpu6DOlAZ4RdhaX2b'
    ...
    def writelnglat(self,address,fh):
        for i in address.iloc[:,1]:  
            address2 = "上海" + i # shang hai+community's name
            try:
    ...
    def getInfo_price(self, file, area,areapy):
        ...
        for pt in price_trend:
            for i in range (0,2):#2 months：dec and nov　
                #December has just begun, so the average house price in December and November is almost the same
    ...
    def grab_data_by_scraping_and_api_requests(self):
        ...
        for i in areaname:
            ...
            for page in range(1, 6):
                test1 = dataset() # Instantiate object
            ...
            test3 = dataset()# Instantiate object
    ...
    def main(self):
        ...
        parser.add_argument("-source", choices=["test", "remote","local"], nargs=1, help="where data should be gotten from")
        # python yuan_jiang_hw5.py -remote REMOTE
        #parser.add_argument("-remote",  nargs=1, help="where data should be gotten from")
